            ...
            VStack(alignment: .leading, spacing: Theme.Space.l) {
                section("What shows", reveal: 0) {
                    ...
                    if toolChat {
                        ...
                        Text("Your own account, in a small built-in browser. Cove is not affiliated with Anthropic, OpenAI, or Google.")
                ...
                section("Life", reveal: 3) {
                    ...
                    if islandMaterial == "glass" {
                        row("Clarity") {
                            picker($glassClarity, [
                                ("Veiled", "veiled"), ("Balanced", "balanced"),
                                ("Clear", "clear"),
                            ])
                        }
                    }
        ...
        return VStack(alignment: .leading, spacing: 2) {
            ...
            if let latest = updates.latest {
                Button {
                    ...
                    Text("Cove \(latest) is out. Install it.")
                        .font(Theme.Fonts.caption)
