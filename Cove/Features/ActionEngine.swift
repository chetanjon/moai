    ...
    func handle(_ raw: String) async -> String? {
        ...
        if screenOneShot || screenRead {
            ...
            case .denied, .needsGrant:
                return "Screen Recording isn't allowed yet. System Settings, Privacy and Security, Screen Recording, then relaunch Cove."
            }
        }
        ...
        // Quit a running app by name. Never Cove itself.
