...
final class NotchViewModel: ObservableObject {
    ...
    private let onboardedKey = "cove.onboarded"
    ...
    /// Default pill for notch-less displays, so Cove works on any Mac.
    ...
    func start() {
        ...
        //   Notification name com.cj.cove.debug.submit, text in object.
        DistributedNotificationCenter.default().addObserver(
            forName: Notification.Name("com.cj.cove.debug.submit"),
            object: nil,
            queue: .main
        ) { [weak self] note in
            ...
            Task { @MainActor in
                ...
                // `defaults read com.cj.cove musicDebug`: the one
                ...
                // without opening it; read com.cj.cove joinDebug.
                if text == "debug join" {
                ...
                // "debug rec" records the live tap to /tmp/cove-tap.caf;
    ...
    /// `defaults read com.cj.cove voiceLog` from a terminal.
