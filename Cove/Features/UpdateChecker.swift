...
final class UpdateChecker: ObservableObject {
    ...
    static let downloadPage = URL(string: "https://github.com/chetanjon/cove/releases/latest")!

    private let releasesAPI = URL(
        string: "https://api.github.com/repos/chetanjon/cove/releases/latest"
    )!
    private let nudgedKey = "cove.lastUpdateNudge"
